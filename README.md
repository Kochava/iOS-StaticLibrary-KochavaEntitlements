# iOS-StaticLibrary-KochavaEntitlements

![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/kochava/iOS-StaticLibrary-KochavaEntitlements?include_prereleases)
